...
movie_titles = ["Titanic", "Blood Diamond", "Romeo + Juliet", "Inception", "Catch Me If You Can"]
parental_rating = ["PG-13", "R", "PG-13", "PG-13", "PG-13"]
bechdel_rating = [3, 1, 3, 3, 1]
imdb_rating = [7.7, 8.0, 6.8, 8.8, 8.0]
genre = ["Drama / Romance", "Adventure / Drama / Thriller", "Drama / Romance", "Action / Mystery / Sci-Fi", "Biography / Crime / Drama"]
...
for title, parental, bechdel, imdb, genre in zip(movie_titles, parental_rating, bechdel_rating, imdb_rating, genre):
	print "{0}, {1}, {2}, {3}, {4}".format(title, parental, bechdel, imdb, genre)
